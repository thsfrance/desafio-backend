...
Route::get('tickets/search/{numregistros}/{page}','TicketController@search')->where(['numregistros' => '[1-9]+', 'page' => '[1-9]+']);
Route::get('tickets/search/{prioridade}/{numregistros}/{page}','TicketController@search')->where(['prioridade' => '([Aa][Ll][Tt][Aa])|([Nn][Oo][Rr][Mm][Aa][Ll])','numregistros' => '[1-9]+', 'page' => '[1-9]+']);
Route::get('tickets/search/{start}/{end}/{numregistros}/{page}','TicketController@search')->where(['start' => '[0-9]{4}-(0[1-9]|1[0,1,2])-([1-9]|0[1-9]|[1,2][0-9]|3[0,1])', 'end' => '[0-9]{4}-(0[1-9]|1[0,1,2])-([1-9]|0[1-9]|[1,2][0-9]|3[0,1])','prioridade' => '[1-9]+','page' => '[1-9]+']);
Route::get('tickets/search/{start}/{end}/{prioridade}/{orderby}/{numregistros}/{page}','TicketController@search')->where(['start' => '[0-9]{4}-(0[1-9]|1[0,1,2])-([1-9]|0[1-9]|[1,2][0-9]|3[0,1])', 'end' => '[0-9]{4}-(0[1-9]|1[0,1,2])-([1-9]|0[1-9]|[1,2][0-9]|3[0,1])','prioridade' => '([Aa][Ll][Tt][Aa])|([Nn][Oo][Rr][Mm][Aa][Ll])','orderby' => '[Dd][Aa][Tt][Aa]([Cc][Rr][Ii][Aa][Cc][Aa][Oo]|[Aa][Tt][Uu][Aa][Ll][Ii][Zz][Aa][Cc][Aa][Oo])','numregistros' => '[1-9]+','page' => '[1-9]+']);
Route::get('tickets/search/{orderby}/{numregistros}/{page}','TicketController@search')->where(['orderby' => '[Dd][Aa][Tt][Aa]([Cc][Rr][Ii][Aa][Cc][Aa][Oo]|[Aa][Tt][Uu][Aa][Ll][Ii][Zz][Aa][Cc][Aa][Oo])','numregistros' => '[1-9]+', 'page' => '[1-9]+']);